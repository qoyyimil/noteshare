...
import 'package:noteshare/auth/auth_gate.dart'; // Mengganti LoginScreen dengan AuthGate
  ...
  void _onMenuItemSelected(String value, BuildContext context) async {
    if (value == 'profile') {
      ...
      Navigator.pushAndRemoveUntil(
        context,
        MaterialPageRoute(builder: (context) => const AuthGate()), // Mengarahkan ke AuthGate setelah logout
        (route) => false,
      );
    }
  }
